...
def _load_setup_module():
    spec = importlib.util.spec_from_file_location("firehouse_setup_under_test", Path("setup.py"))
...
def test_create_default_admin_normalizes_env_username(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("FIREHOUSE_ADMIN_USER", " AdminUser ")
    monkeypatch.setenv("FIREHOUSE_ADMIN_PASSWORD", "temporary-password")

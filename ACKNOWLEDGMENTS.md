...
Firehouse stands on the shoulders of a lot of open-source work. This file
...
- **[llmfit](https://github.com/AlexsJones/llmfit)** by **Alex Jones** — the
  ...
  and `scripts/firehouse-cookbook`.
- **[Tongyi DeepResearch](https://github.com/Alibaba-NLP/DeepResearch)** by
  **Alibaba-NLP / Tongyi Lab** — the multi-step deep-research agent pipeline.
  Copyright © Alibaba-NLP / Tongyi Lab. **Apache-2.0.** Adapted for Firehouse's
...
and run alongside Firehouse on `docker compose up`. They are not modified —
just composed.
...
Firehouse talks to these over the network/API. They are **not** distributed
...
- **`caldav`** (Python lib) is **dual-licensed GPL-3.0-or-later OR Apache-2.0**.
  Firehouse uses it under **Apache-2.0**, which is permissive and MIT-compatible.

---

## Thanks to

Most of Firehouse's code was written *with* AI models, not just by a human.

...
INTERNAL_TOOL_TOKEN = os.environ.get("FIREHOUSE_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-Firehouse-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-Firehouse-Internal-Token), or

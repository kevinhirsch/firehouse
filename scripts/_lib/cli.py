"""scripts/_lib/cli.py — shared scaffolding for the `firehouse-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("firehouse-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/firehouse-foo`
...
VERSION = "0.1.0"  # bumped centrally; every firehouse-* CLI reports this

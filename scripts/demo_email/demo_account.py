#!/usr/bin/env python3
"""Create/remove the switchable, non-default 'Demo' EmailAccount in Firehouse.

Mirrors the existing local-Dovecot account (localhost:31143, STARTTLS) but points
at the throwaway demo@firehouse.local mailbox. Password is stored Fernet-encrypted
...
NAME = "Demo"
IMAP_USER = "demo@firehouse.local"

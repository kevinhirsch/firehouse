...
function initMermaid() {
  if (!window.mermaid || window.__firehouseMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__firehouseMermaidReady = true;
}
window.firehouseInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'firehouse-thinking-expanded';

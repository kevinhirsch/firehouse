...
Streaming agent loop for firehouse-ui.
...
```
GENERIC LOOPBACK to ANY Firehouse internal endpoint. Use this whenever the user wants something the UI can do but there's NO named tool for it. Every UI button hits some /api/* endpoint — you can hit the same one. Auth is handled automatically.
